    ...
    <View style={styles.container}>
      ...
      {!successfulCreation && (
        <>
          ...
          <Button onPress={onRequestReset} title="Send Reset Email" color={Colors.BUTTON_COLOR}></Button>
        </>
      )}
      ...
      {successfulCreation && (
        <>
          ...
          <Button onPress={onReset} title="Set new Password" color={Colors.BUTTON_COLOR}></Button>
        </>
      )}
    </View>
  );
